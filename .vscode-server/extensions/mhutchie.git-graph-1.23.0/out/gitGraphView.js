        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (msg.command) {
                ...
                case 'loadCommits':
                    ...
                    this.sendMessage(Object.assign({ command: 'loadCommits', refreshId: msg.refreshId, onlyFollowFirstParent: msg.onlyFollowFirstParent }, yield this.dataSource.getCommits(msg.repo, msg.branches, msg.maxCommits, msg.showTags, msg.showRemoteBranches, msg.includeCommitsMentionedByReflogs, msg.onlyFollowFirstParent, msg.remotes, msg.hideRemotes, msg.stashes)));
                    break;
                case 'loadRepoInfo':
