...
[中文文档](https://github.com/sumnow/markdown-formatter/blob/master/./CHANGELOG_CN.md)
...
- Fix bug: [[Error Format]:TypeError: Cannot read property 'forEach' of null](https://github.com/sumnow/markdown-formatter/issues/28)
- Update `CHANGELOG.md`
...
- Fix bug: [能否不要删除code block](https://github.com/sumnow/markdown-formatter/issues/18)


## 0.8.0

- Fix bug: [It's not formatting properly lines that contain regexp](https://github.com/sumnow/markdown-formatter/issues/22)
- Fix bug: [Formatting adds a "*" to Markdown Rules](https://github.com/sumnow/markdown-formatter/issues/23)

## 0.7.9

- Fix bug: [列表接着一级标题格式化出错 [#16](https://github.com/sumnow/markdown-formatter/issues/16)](https://github.com/sumnow/markdown-formatter/issues/16)
- Update `CHANGELOG.md`
...
- Fix bug: [格式化操作会破坏`markdown-all-in-one`插件生成的目录](https://github.com/sumnow/markdown-formatter/issues/8)
- Fix bug: [格式化操作会破坏原有链接](https://github.com/sumnow/markdown-formatter/issues/9)
- Update `CHANGELOG.md`
